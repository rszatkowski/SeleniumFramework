...
public class PrividerPage {
    ...
    private Logger log = Logger.getLogger(PrividerPage.class);

    public PrividerPage(WebDriver driver) {
        PageFactory.initElements(driver, this);
        this.helper = new SeleniumHelper(driver);
        this.driver = driver;
    }

    public PrividerPage waitForHomePageLoad() {
